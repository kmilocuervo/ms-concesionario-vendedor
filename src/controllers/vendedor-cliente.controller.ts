...
export class VendedorClienteController {
  ...
  async find(
    ...
    return this.vendedorRepository.vendedortieneclientes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vendedorRepository.vendedortieneclientes(id).create(cliente);
  }
  ...
  async patch(
    ...
    return this.vendedorRepository.vendedortieneclientes(id).patch(cliente, where);
  }
  ...
  async delete(
    ...
    return this.vendedorRepository.vendedortieneclientes(id).delete(where);
  }
}
